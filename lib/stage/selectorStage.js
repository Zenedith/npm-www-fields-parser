...
exports.SelectorStage = function SelectorStage(selector, contextName, handlers) {
  ...
  this.contextName = contextName || undefined;
  this.handlers = [];
  ...
  this.val = function val() {
    this.handlers.push(function val() {
      return this.val();
    });
  ...
  this.html = function html() {
    this.handlers.push(function html() {
      return this.html();
    });
  ...
  this.text = function text() {
    this.handlers.push(function text() {
      return this.text();
    });
  ...
  this.attr = function attr(attrValue) {
    this.handlers.push(function attr() {
  ...
  this.find = function find(findValue) {
    this.handlers.push(function find() {
  ...
  this.parent = function parent() {
    this.handlers.push(function parent() {
      return this.parent();
    });
  ...
  this.next = function next() {
    this.handlers.push(function next() {
      return this.next();
    });
  ...
  this.prev = function prev() {
    this.handlers.push(function prev() {
      return this.prev();
    });
  ...
  this.children = function children(childrenValue) {
    this.handlers.push(function children() {
  ...
  this.first = function first() {
    this.handlers.push(function first() {
      return this.first();
    });
      ...
      if (handlers.hasOwnProperty(i)) {
        ...
        switch (handler) {
          ...
          case 'first' :
            ...
            break;
          default:
            logger.warn('Invalid handler: ' + handlers[i]);
        }
      }
    }
  }
  ...
  this.execute = function (value, options, callback) {
    ...
    if (!isEmptySelector(selectorValue)) {
      ...
      logger.debug('Unable to find value for given selector: ' + this.selector);
    }
